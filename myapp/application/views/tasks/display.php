...
<ul class="list-group">		
    <h4>Task Actions</h4>
		<li class="list-group-item"><a class="text-warning" href="<?php echo base_url(); ?>tasks/edit/<?php echo $task->project_id; ?>/<?php echo $task->id; ?>">Edit Task</a></li> 
		<li class="list-group-item"><a class="text-danger" href="<?php echo base_url(); ?>tasks/delete/<?php echo $task->project_id; ?>/<?php echo $task->id; ?>">Delete Task</a></li> 
